package xyz.zzulu.savethecolor.data;

/**
 * Created by hwangjw on 16. 6. 18.
 */
...
/**
 * Static methods for dealing with {@link xyz.zzulu.savethecolor.data.ColorItem}s.
 */
public final class ColorItems {

    /**
     * A key for saving the {@link xyz.zzulu.savethecolor.data.ColorItem}s of the user.
     */
    ...
    /**
     * A {@link java.lang.reflect.Type} instance of a {@link java.util.List} of {@link xyz.zzulu.savethecolor.data.ColorItem}s.
     */
    private static final Type COLOR_ITEM_LIST_TYPE = new TypeToken<List<ColorItem>>() {
    }.getType();

    /**
     * A {@link java.util.Comparator} for sorting {@link xyz.zzulu.savethecolor.data.ColorItem}s in chronological order of creation.
     */
    ...
    /**
     * Get the {@link xyz.zzulu.savethecolor.data.ColorItem}s of the user.
     *
     * @param context a {@link android.content.Context}.
     * @return a {@link java.util.List} of {@link xyz.zzulu.savethecolor.data.ColorItem}s.
     */
     ...
     * Get the {@link xyz.zzulu.savethecolor.data.ColorItem}s of the user.
     *
     * @param sharedPreferences a {@link android.content.SharedPreferences} from which the {@link xyz.zzulu.savethecolor.data.ColorItem}s will be retrieved.
     * @return a {@link java.util.List} of {@link xyz.zzulu.savethecolor.data.ColorItem}s.
     */
    ...
    /**
     * Save a {@link xyz.zzulu.savethecolor.data.ColorItem}s.
     *
     * @param context     a {@link android.content.Context}.
     * @param colorToSave the {@link xyz.zzulu.savethecolor.data.ColorItem} to save.
     * @return Returns true if the new {@link xyz.zzulu.savethecolor.data.ColorItem} was successfully written to persistent storage.
     */
    ...
    /**
     * Delete a {@link xyz.zzulu.savethecolor.data.ColorItem}.
     *
     * @param context           a {@link android.content.Context}.
     * @param colorItemToDelete the {@link xyz.zzulu.savethecolor.data.ColorItem} to be deleted.
     ...
     *
     * @param context                   a {@link android.content.Context}.
     * @param onColorItemChangeListener the {@link xyz.zzulu.savethecolor.data.ColorItem} to register.
     */
    ...
    /**
     * Unregister a {@link xyz.zzulu.savethecolor.data.ColorItem}.
     *
     * @param context                   a {@link android.content.Context}.
     * @param onColorItemChangeListener the {@link xyz.zzulu.savethecolor.data.ColorItem} to unregister.
     */
    ...
    /**
     * A simple class for listening to the changes of the {@link xyz.zzulu.savethecolor.data.ColorItem}s of the user.
     */
    public abstract static class OnColorItemChangeListener implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        /**
         * Called when the {@link xyz.zzulu.savethecolor.data.ColorItem}s of the user have just changed.
         *
         * @param colorItems the current {@link java.util.List} of the {@link xyz.zzulu.savethecolor.data.ColorItem}s of the user.
         */
