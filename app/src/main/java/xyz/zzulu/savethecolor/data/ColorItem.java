...
public class ColorItem implements Parcelable {
    ...
    /**
     * Create a new {@link xyz.zzulu.savethecolor.data.ColorItem} with an id and a color.
     *
     * @param id    the id of the {@link xyz.zzulu.savethecolor.data.ColorItem}. Should be unique.
    ...
    /**
     * Create a new {@link xyz.zzulu.savethecolor.data.ColorItem} from a {@link android.os.Parcel}.
     * <p/>
     * Used by the parcelable creator.
     * {@link xyz.zzulu.savethecolor.data.ColorItem#CREATOR}.
     *
    ...
    /**
     * Create a new {@link xyz.zzulu.savethecolor.data.ColorItem} with a color.
     * <p/>
     * The {@link xyz.zzulu.savethecolor.data.ColorItem#mId} is set to the {@link xyz.zzulu.savethecolor.data.ColorItem#mCreationTime}.
     *
     * @param color the color value.
     */
    ...
    /**
     * Get the id of the {@link xyz.zzulu.savethecolor.data.ColorItem}.
     *
     * @return the id of the {@link xyz.zzulu.savethecolor.data.ColorItem}.
     */
    public long getId() {
        return mId;
    }
    ...
    /**
     * Get the value of the {@link xyz.zzulu.savethecolor.data.ColorItem}.
     *
     * @return an integer representing the color value of the {@link xyz.zzulu.savethecolor.data.ColorItem}.
     */
    public int getColor() {
        return mColor;
    }
    ...
    /**
     * Set the color valur of the {@link xyz.zzulu.savethecolor.data.ColorItem}.
     *
     * @param color an integer representing the new color value of the {@link xyz.zzulu.savethecolor.data.ColorItem}.
     */
    ...
    /**
     * Get the creation time of the {@link xyz.zzulu.savethecolor.data.ColorItem}.
     *
    ...
    /**
     * A {@link android.os.Parcelable.Creator} for creating {@link xyz.zzulu.savethecolor.data.ColorItem} from {@link android.os.Parcel}.
     */
